    ...
    <div class="row">
            ...
            <div class="mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7"><input id="fullname" type="text" class="form-control"
                            style="transform: translateX(-10px)" value="{{ $item->fullname }}"></div>
        ...
        <div class="col-lg-6">
            <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-lg-8"><input id="surchargepayment" value="{{ $item->surchargepayment }}"
                            type="number" class="form-control" style="transform: translateX(-10px)"></div>
                    <div class="col-lg-4">
        ...
        <div class="col-lg-6">
            <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-lg-8"><input id="DHI" value="{{ $item->DHI }}" type="number" class="form-control"
        ...
        {{-- <div class="col-lg-6">
            <div class="mb-3">
                <label class="form-label">surcharge for payment by credit card</label>
                <div class="row">
                    <div class="col-lg-8"><input id="surchargepayment2" value="{{ $item->surchargepayment2 }}"
                            type="number" class="form-control" style="transform: translateX(-10px)"></div>
                    <div class="col-lg-4">
                ...
                <div class="row">
                    ...
                    <ul id="Service" style="list-style: none;">
                        <li id="Operation" onclick="getValue(this)" style="padding: 5px 0;"><span><input type="checkbox"
                                    value="Operation" {!! strpos($item->services, 'Operation') !== false ? 'checked' :
                                null !!}/></span><span style="padding: 0 10px;">Operation</span></li>
                        <li id="AirportTransfers" onclick="getValue(this)" style="padding: 5px 0;"><span><input
                                    type="checkbox" value="Airport Transfers" {!! strpos($item->services, 'Airport Transfers') !== false ? 'checked' : null !!}/></span><span
                        ...
                        <li id="Hotel" onclick="getValue(this)" style="padding: 5px 0;"><span><input type="checkbox"
                                    value="Hotel" {!! strpos($item->services, 'Hotel') !== false ? 'checked' : null
                                !!}/></span><span style="padding: 0 10px;">Hotel</span></li>
                        <li id="Flights" onclick="getValue(this)" style="padding: 5px 0;"><span><input type="checkbox"
                                    value="Flights" {!! strpos($item->services, 'Flights') !== false ? 'checked' : null
                                !!}/></span><span style="padding: 0 10px;">Flights</span></li>
                        <li id="Post-Op" onclick="getValue(this)" style="padding: 5px 0;"><span><input type="checkbox"
                                    value="Post-Op" {!! strpos($item->services, 'Post-Op') !== false ? 'checked' : null
                                !!}/></span><span style="padding: 0 10px;">Post-Op</span></li>
                        <ul>
                </div>
            </div>
        </div>
        ...
        <div class="btnContainer">
            <div class="btnBox">
                <button id="save-btn" onclick="saveInformation({{ $data }})"
